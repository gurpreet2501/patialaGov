									...
									<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
									  <div class="carousel-inner" role="listbox">
									    <div class="item active">
									      <img src="images/slider-1.jpg" class='slider-images' alt="">
									      <div class="carousel-caption">
									        
									      </div>
									    </div>
									    <div class="item">
									      <img src="images/slider-3.jpg" class='slider-images' alt="">
									      <div class="carousel-caption">
									        
									      </div>
									    </div>
									    <div class="item">
									      <img src="images/slider-2.jpg" class='slider-images' alt="">
									      <div class="carousel-caption">
									        
									      </div>
									    </div>
									    <div class="item">
									      <img src="images/Fountain.JPG" class='slider-images' alt="">
									      <div class="carousel-caption">
									        
									      </div>
									    </div>
									    <div class="item">
									      <img src="images/Dukhniwaran.JPG" class='slider-images' alt="">
									      <div class="carousel-caption">
